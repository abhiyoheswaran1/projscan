...
- **Framework dataflow precision.** Hono, Express, Fastify, and Koa request sources are framework-gated and fixture-backed, including Hono validator output, Express/Fastify/Koa request IP metadata, and Express/Koa header-accessor patterns without flagging lookalike helpers.
