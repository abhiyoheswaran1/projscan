...
`projscan start --proof-commands --intent "<goal>"` prints the remaining ready proof commands, one per line, when a developer just needs the verification commands without the full report.
