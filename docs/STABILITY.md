...
- **Command names**: `analyze`, `apply-fix`, `audit`, `badge`, `bug-hunt`, `ci`, `coupling`, `coverage`, `dependencies`, `diagram`, `diff`, `doctor`, `evidence-pack`, `explain`, `explain-issue`, `file`, `fix`, `fix-suggest`, `handoff`, `hotspots`, `impact`, `init`, `install-hook`, `mcp`, `memory`, `outdated`, `plugin`, `preflight`, `pr-diff`, `release-train`, `regression-plan`, `review`, `search`, `session`, `structure`, `taint`, `upgrade`, `watch`, `workplan`, `workspace`, `workspaces`. New commands may be added; existing names will not be renamed or removed.
