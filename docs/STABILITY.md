...
- **Tool names** (via `tools/list`): `projscan_analyze`, `projscan_doctor`, `projscan_hotspots`, `projscan_explain`, `projscan_file`, `projscan_structure`, `projscan_dependencies`, `projscan_outdated`, `projscan_audit`, `projscan_upgrade`, `projscan_coverage`, `projscan_graph`, `projscan_coupling`, `projscan_workspaces`, `projscan_pr_diff`, `projscan_review`, `projscan_workplan`, `projscan_fix_suggest`, `projscan_explain_issue`, `projscan_impact`, `projscan_search`, `projscan_session`, `projscan_memory`, `projscan_workspace_graph`, `projscan_apply_fix`, `projscan_taint`, `projscan_cost_summary`, `projscan_review_watch`, `projscan_plugin`, `projscan_preflight`. New tools may be added without a major bump; existing names will not be renamed or removed.
