...
- `projscan init github-action`: pull-request workflow scaffold that runs projscan and posts PR evidence comments.
...
- Readiness Evidence: product-line planning, approval packets, GitHub PR comment evidence, and smoke/focused/full regression matrices.
...
- "Add PR evidence automation" with npx projscan init github-action.
