...
- `https://www.baseframelabs.com/apps/projscan` already shows `4.9.3`, the
  `README And Demo Refresh` story, `47` MCP tools, and the current Mission
  Control media.
- `https://www.baseframelabs.com/apps/projscan/docs` still shows a `Changelog
  4.9.1` nav label and should move to the 4.11.0 story.
- Keep 4.0 migration content and 4.9 trust-patch details as historical context.

```text
Update the projscan website for projscan 4.11.0.
...
Release headline:
4.11.0: Proof-First Engineering Command Center

Primary story:
projscan 4.11.0 turns local scan output into a proof-first engineering command
center. It adds `projscan assess` with Proof Cards and `projscan simulate --plan`
with risk delta prediction so engineers can see what is risky, why it matters,
...
- Version labels: `4.0.0`, `4.3.1`, `4.4.0`, `4.7.0`, `4.8.0`, `4.9.0`,
  `4.9.1`, `4.9.2`, `4.9.3`, or `4.10.0` -> `4.11.0`.
- Navigation/changelog labels: `Changelog 4.0.0`, `Changelog 4.3.1`,
  ...
  `Changelog 4.9.3`, or `Changelog 4.10.0` -> `Changelog 4.11.0`.
- Release notes headings: old `Shipped in ...` headings -> `Shipped in 4.11.0.`
- Replace any release-current `4.9.3` or `4.10.0` copy with the 4.11.0 proof-first story.
...
New release-note bullets for 4.11.0:
...
Screenshots/media:
- Use the README media after the `v4.11.0` tag is live:
  - `https://raw.githubusercontent.com/abhiyoheswaran1/projscan/v4.11.0/docs/projscan-mission-control.png`
  - `https://raw.githubusercontent.com/abhiyoheswaran1/projscan/v4.11.0/docs/projscan-proof-router.png`
  - `https://raw.githubusercontent.com/abhiyoheswaran1/projscan/v4.11.0/docs/projscan-mission-control.gif`
  - `https://raw.githubusercontent.com/abhiyoheswaran1/projscan/v4.11.0/docs/projscan-mission-proof.gif`
...
projscan 4.11.0 is the proof-first engineering command center release. It adds
`projscan assess` with Proof Cards and `projscan simulate --plan` with risk
delta prediction, so engineers can see the safest next change, the evidence
behind it, and the commands that prove it. Core scans still run locally by
default, source is not uploaded, and telemetry stays off until someone opts in.

Verification before publishing:
- Confirm every visible version/changelog label reads 4.11.0.
...
- Confirm the screenshots load from the `v4.11.0` raw GitHub URLs after the tag
  is pushed.
- Search the rendered site for `4.9.3` and `4.10.0`; remaining hits should be historical
...
- Changelog source: `CHANGELOG.md` entry for `4.11.0`
