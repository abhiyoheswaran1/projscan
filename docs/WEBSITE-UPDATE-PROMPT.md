...
- Registry description: Agent-first code intelligence over MCP. 11 langs, 46 tools, repo understanding. Local.
...
- 46 MCP tools for repo understanding, structural code intelligence, semantic graph, dataflow, adoption guidance, and release readiness.
