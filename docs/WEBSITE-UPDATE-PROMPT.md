...
```text
Update the projscan website for projscan 2.9.0 "Adoption Layer".

Core positioning:
- Name: projscan
- MCP Registry name: io.github.abhiyoheswaran1/projscan
- Registry description: Agent-first code intelligence over MCP. 11 langs, 37 tools, client setup, plugins. Offline.
- One-line homepage copy: Agent-first code intelligence for AI coding agents: ready-to-paste MCP setup, workflow recipes, first-run diagnostics, workplans, bug-hunt queues, readiness evidence, compact agent briefs, quality scorecards, preflight safety, review intelligence, shared session context, and local team plugins.
...
- 37 MCP tools for structural code intelligence and adoption guidance.
