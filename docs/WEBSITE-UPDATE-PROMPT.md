...
- This update should move the site from the 4.0.0 consolidation story to the 4.9.1 Daily Workflow Proof Hardening story. Keep the 4.0 migration section as historical context.

```text
Update the projscan website for projscan 4.9.1.
...
Release headline:
4.9.1: Daily Workflow Proof Hardening

Primary story:
projscan now leads agents through three repeatable proof workflows before the broad command catalog: before editing, before handoff or commit, and before release-candidate review. The 4.9.1 train adds Daily Workflows output, quieter release-candidate proof, visible offline privacy checks, calibrated manual sign-off wording, refreshed README media, and CI aligned with the current source test harness while preserving local-first review evidence.
...
- Keep 4.0 migration content, but move it below the new 4.9.1 release story.

Stale live-site claims to update:
- Version: `4.0.0`, `4.3.1`, `4.4.0`, `4.7.0`, `4.8.0`, or `4.9.0` -> `4.9.1`.
- Navigation/changelog label: `Changelog 4.0.0`, `Changelog 4.3.1`, `Changelog 4.4.0`, `Changelog 4.7.0`, `Changelog 4.8.0`, or `Changelog 4.9.0` -> `Changelog 4.9.1`.
- Release notes heading: `Shipped in 4.0.0.`, `Shipped in 4.3.1.`, `Shipped in 4.4.0.`, `Shipped in 4.7.0.`, `Shipped in 4.8.0.`, or `Shipped in 4.9.0.` -> `Shipped in 4.9.1.`
...
New release-note bullets for 4.9.1:
...
- README and media refresh: Playwright screenshots and VHS demos now match the 4.9.1 proof workflow and trust wording.
- Release CI alignment: CI now runs the full source test harness on Node 20, 22, and 24, with a separate Node 18 packed-install smoke job for published package compatibility.
...
- Release trust: mention there are no MCP tool removals in 4.9.1. This release adds Daily Workflows output, quieter release-candidate proof, visible offline privacy checks, manual sign-off calibration, global install cleanup, refreshed proof media, and CI alignment with the current source test harness plus a Node 18 packed-install smoke job.
...
- Keep the 4.0 migration section in place, and state that 4.9.1 is additive.

Screenshots/media:
- Use the README media after the `v4.9.1` tag is live:
  - `https://raw.githubusercontent.com/abhiyoheswaran1/projscan/v4.9.1/docs/projscan-mission-control.png`
  - `https://raw.githubusercontent.com/abhiyoheswaran1/projscan/v4.9.1/docs/projscan-proof-router.png`
  - `https://raw.githubusercontent.com/abhiyoheswaran1/projscan/v4.9.1/docs/projscan-mission-control.gif`
  - `https://raw.githubusercontent.com/abhiyoheswaran1/projscan/v4.9.1/docs/projscan-mission-proof.gif`
...
- Confirm the screenshots load from the `v4.9.1` raw GitHub URLs after the tag is pushed.
...
- Changelog source: `CHANGELOG.md` entry for `4.9.1`
