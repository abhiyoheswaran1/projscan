...
| **Agent-ergonomic surface** | intent router | One adaptive entry tool returning budget-shaped next actions, shrinking the 45-tool list footprint agents pay for on every turn. Likely the 4.0 stability break. |
