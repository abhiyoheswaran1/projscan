import { PR_DIFF_KEYWORDS } from './intentRouterPrDiffKeywords.js';
...
export const ROUTE_CATALOG: RouteEntry[] = [
  ...
  {
    intent: 'Share scoped redacted evidence artifacts',
    category: 'Review',
    tool: 'projscan_analyze',
    cli: 'projscan analyze',
    what: 'Scoped and redacted analyze, doctor, and CI artifacts for external review.',
    why: 'When a security reviewer, partner, or release owner needs shareable evidence without raw repo paths.',
    example: 'projscan analyze --report-scope src/api --redact-paths --format json',
    keywords: [
      'share',
      'shared',
      'shareable',
  ...
  {
    intent: 'Create a Proof Contract for an agent change',
    category: 'Proof',
    tool: 'projscan_prove',
    cli: 'projscan prove',
    what: 'Executable Proof Contract and replayed Proof Receipt for a bounded change.',
    why: 'Before an agent edits, constrain allowed files, forbidden files, proof commands, and reviewer evidence.',
    example:
  ...
  {
    intent: 'Capture raw feedback',
    category: 'Adoption',
    tool: 'projscan_feedback_intake',
    cli: 'projscan feedback intake',
    what: 'Classify pasted reviewer or agent feedback into a focused task and verification path.',
    why: 'When an agent receives false-positive, noisy-output, missing-signal, or usefulness feedback that should improve projscan.',
    example: "projscan feedback intake --text '<feedback>' --format json",
    keywords: [
      'feedback',
      'reviewer',
      'reviewers',
